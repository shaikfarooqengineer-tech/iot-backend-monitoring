        ...
        <div className="max-w-[1800px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="live-indicator" data-testid="connection-status">
              <span className={`live-dot ${isConnected ? '' : 'bg-red-500'}`}></span>
            ...
            <div className="flex items-center gap-3" data-testid="user-profile">
              <div className="text-right">
                ...
                <p className="text-xs text-slate-500">Caregiver | Online</p>
              </div>
      ...
      <main className="p-6 max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6" data-testid="vitals-row">
          ...
          <Card className="vital-card" data-testid="heart-rate-card">
            <CardContent className="p-0">
              <div className="flex items-start justify-between">
                <div className="icon-container icon-heart">
                  <Heart className="w-6 h-6" fill="currentColor" />
                </div>
                <Badge 
                  className={vitals.heart_rate_status === 'Normal' ? 'badge-normal' : 'badge-warning'}
                  data-testid="heart-rate-status"
                >
          ...
          <Card className="vital-card" data-testid="respiration-card">
            <CardContent className="p-0">
              <div className="flex items-start justify-between">
                <div className="icon-container icon-breath">
                  <Wind className="w-6 h-6" />
                </div>
                <Badge 
                  className={vitals.respiration_status === 'Steady' ? 'badge-normal' : 'badge-warning'}
                  data-testid="respiration-status"
                >
          ...
          <Card className="vital-card" data-testid="sleep-status-card">
            <CardContent className="p-0">
              <div className="flex items-start justify-between">
                <div className="icon-container icon-sleep">
                  <Moon className="w-6 h-6" />
                </div>
                <Badge 
                  className={vitals.sleep_quality === 'Stable' ? 'badge-normal' : 'badge-info'}
                  data-testid="sleep-quality-status"
                >
          ...
          <Card className="vital-card" data-testid="fall-detection-card">
            <CardContent className="p-0">
              <div className="flex items-start justify-between">
                <div className="icon-container icon-fall">
                  <AlertTriangle className="w-6 h-6" />
                </div>
                <Badge 
                  className={!vitals.fall_detected ? 'badge-normal' : 'badge-danger'}
                  data-testid="fall-detection-status"
                >
                  {vitals.fall_status}
                </Badge>
              </div>
        ...
        {/* Second Row - Room Status and Alerts */}
                  ...
                  <div className="text-center">
                    ...
                    <div className="bg-white rounded-lg px-3 py-2 shadow-sm border border-slate-200">
                      <p className="text-sm font-medium text-slate-700">
                        {room_status.presence_detected ? 'Presence Detected' : 'No Presence'} | Distance: <span className="font-bold">{room_status.distance} m</span>
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* Fourth Row - Sleep, Activity, Device Status */}
              ...
              <div className="space-y-3">
                ...
                <div className="mt-4 p-3 bg-slate-100 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="device-indicator-dot connected"></div>
